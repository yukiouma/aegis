...
#[openapi(
    ...
    components(schemas(
        ...
        dto::CodeListListResponse,
        dto::CodeItemViewResponse,
        dto::CodeItemListResponse,
        dto::CodeListSearchHitResponse,
        dto::CodeItemSearchHitResponse,
        dto::CodeListSearchHitsResponse,
        dto::CodeItemSearchHitsResponse,
        ...
        dto::TerminologySearchBaseQuery,
        dto::TerminologyVersionByNameQuery,
...
mod tests {
    ...
    fn openapi_registers_wire_dto_schemas() {
        ...
        for name in [
            ...
            "CodeListSearchHitResponse",
            "CodeItemSearchHitResponse",
            "CodeListSearchHitsResponse",
            "CodeItemSearchHitsResponse",
