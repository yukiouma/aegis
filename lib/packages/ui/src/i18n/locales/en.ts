export const en = {
  ...
  "crf.globalSearch.searchPlaceholder":
    "Search forms, items, units, options, domain annotations, annotations…",
  "crf.globalSearch.emptyInput":
    "Type a search term to find forms, items, units, options, domain annotations, or annotations",
  ...
  "crf.globalSearch.ownerKind.form": "Form",
  "crf.globalSearch.ownerKind.item": "Item",
  "crf.globalSearch.ownerKind.option": "Option",
  "crf.globalSearch.ownerKind.unit": "Unit",
  ...
  "crf.globalSearch.loadFailed.domainAnnotations":
    "Failed to load domain annotations: {message}",
  "crf.globalSearch.loadFailed.annotations":
  ...
  "crf.globalSearch.noMatches.domainAnnotations":
    "No matching domain annotations",
  ...
  "crf.missionAssign.heading": "Assignees for {code}",
  ...
  "crf.missionAssign.failure": "Could not update assignees",
  ...
  "crf.missionIssue.detail.submitComment": "Comment",
  ...
  "crf.domainDialog.notSubmit": "Not submit",
